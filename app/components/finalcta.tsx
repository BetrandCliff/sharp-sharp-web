  ...
  return (
    <section className="py-24 border-t border-zinc-800 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center px-6 relative z-10">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-zinc-800 bg-zinc-900 text-[11px] text-zinc-400 mb-6">
        ...
        <p className="text-sm text-zinc-400 mb-10 max-w-2xl mx-auto leading-6">
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center px-6 py-2.5 border border-zinc-700 hover:border-zinc-500 text-sm rounded-lg text-zinc-300 hover:text-white transition"
          >
            Contact Sales
          </Link>
        </div>

        <div className="flex items-center justify-center gap-3 text-[11px] text-zinc-500 mt-8 flex-wrap">
